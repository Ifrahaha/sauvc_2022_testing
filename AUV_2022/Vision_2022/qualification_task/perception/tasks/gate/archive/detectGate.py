...
video_file = '/home/crossfire/Programming projects/perception/perception/Course Footage/GOPR1142.MP4'
EPSILON = 40
OVERLAP_EPS = 40
...
def getContours(image):
	...
	img, contours = cv2.findContours(image.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
